...
import { Calendar, TrendingUp, Users, DollarSign, Target, FileText, Settings, Download, Plus, Eye, MessageSquare, CheckCircle, Award, Clock, Send, UserCheck } from 'lucide-react';

const GrantsAnalyticsTool = () => {
  ...
  const metricsLibrary = [
    ...
    { id: 'reviewer_efficiency', name: 'Review Completion Time', category: 'Process Efficiency', type: 'leading', description: 'Average time for reviewers to complete evaluations' },
    { id: 'application_quality', name: 'Application Quality Score', category: 'Quality Metrics', type: 'leading', description: 'Average quality rating of submitted applications' },
    { id: 'funding_utilization', name: 'Fund Utilization Rate', category: 'Funding', type: 'lagging', description: 'Percentage of available funds that are awarded' },
    { id: 'user_satisfaction', name: 'Applicant Satisfaction Score', category: 'User Experience', type: 'leading', description: 'Satisfaction rating from applicant feedback surveys' },
    { id: 'drop_off_rate', name: 'Application Drop-off Rate', category: 'User Experience', type: 'leading', description: 'Percentage of users who abandon applications mid-process' },
    { id: 'resubmission_rate', name: 'Resubmission Rate', category: 'Quality Metrics', type: 'lagging', description: 'Percentage of applications requiring resubmission' }
  ];
  ...
  const sampleData = {
    ...
    application_funnel: [
      { stage: 'Started', value: 1000, users: 1000 },
      { stage: 'Basic Info', value: 850, users: 850 },
      { stage: 'Project Details', value: 680, users: 680 },
      { stage: 'Budget', value: 520, users: 520 },
      { stage: 'Documents', value: 420, users: 420 },
      { stage: 'Submitted', value: 380, users: 380 }
    ],
    ...
    reviewer_workload: [
      ...
      { reviewer: 'Dr. Wilson', assigned: 41, completed: 39, avg_time: 3.5 },
      { reviewer: 'Prof. Brown', assigned: 36, completed: 36, avg_time: 2.9 }
    ]
  };
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow border">
              ...
              <div className="space-y-3">
                ...
                <div className="border rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    <Award className="text-blue-600 mt-1" size={16} />
                    <div>
                ...
                <div className="border rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    <UserCheck className="text-purple-600 mt-1" size={16} />
                    <div>
                      <h4 className="font-medium">Applicant Experience Enhancement</h4>
                      <p className="text-sm text-gray-600">Application completion rate improved to 38% following UX improvements and guided assistance features.</p>
                    </div>
                  </div>
                </div>
                <div className="border rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    <DollarSign className="text-yellow-600 mt-1" size={16} />
                    <div>
            ...
            <div className="bg-white p-6 rounded-lg shadow border">
              <h3 className="text-lg font-semibold mb-4">Action Items for Next Quarter</h3>
              <div className="space-y-3">
                <div className="flex items-center gap-3 p-3 border rounded-lg">
                  <CheckCircle className="text-gray-400" size={16} />
                  <div className="flex-1">
                    <p className="font-medium">Implement AI-powered application screening</p>
                    <p className="text-sm text-gray-600">Reduce initial review time and improve consistency in preliminary assessments</p>
                  </div>
                ...
                <div className="flex items-center gap-3 p-3 border rounded-lg">
                  <CheckCircle className="text-gray-400" size={16} />
                  <div className="flex-1">
                    <p className="font-medium">Launch applicant mentorship program</p>
                    <p className="text-sm text-gray-600">Support first-time applicants to improve application quality and success rates</p>
                  </div>
                ...
                <div className="flex items-center gap-3 p-3 border rounded-lg">
                  <CheckCircle className="text-gray-400" size={16} />
                  <div className="flex-1">
                    <p className="font-medium">Develop impact measurement framework</p>
                    <p className="text-sm text-gray-600">Create systematic approach to track and report on funded project outcomes</p>
                  </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow border">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <span className="text-xs text-gray-600">Target: 15 days</span>
                </div>
              </div>
            </div>

            <div className="bg-white p-6 rounded-lg shadow border">
              <h3 className="text-lg font-semibold mb-4">Stakeholder Communications</h3>
              <div className="space-y-3">
                <div className="flex items-center gap-3 p-3 border rounded-lg">
                  <Eye className="text-blue-600" size={16} />
                  <div>
                    <p className="font-medium text-sm">Board of Directors</p>
                    <p className="text-xs text-gray-600">Quarterly review Jul 15</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 border rounded-lg">
                  <MessageSquare className="text-green-600" size={16} />
                  <div>
                    <p className="font-medium text-sm">Program Committee</p>
                    <p className="text-xs text-gray-600">Monthly update Jul 8</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 border rounded-lg">
                  <FileText className="text-purple-600" size={16} />
                  <div>
                    <p className="font-medium text-sm">Public Impact Report</p>
                    <p className="text-xs text-gray-600">Due Jul 30</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex space-x-8">
            {[
              ...
              { id: 'metrics', name: 'Grant Metrics', icon: Target },
              { id: 'review', name: 'Quarterly Review', icon: FileText }
            ].map(tab => (
              <button
                key={tab.id}
