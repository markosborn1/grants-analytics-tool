      ...
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-2">
            ...
            >
              {metricsEditMode ? '✓ Save Changes' : '✏️ Edit Mode'}
            </button>
            <button 
      ...
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-2">
            ...
            >
              {reviewEditMode ? '✓ Save Changes' : '✏️ Edit Mode'}
            </button>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow border">
          <h3 className="text-lg font-semibold mb-4">Quarterly Performance Targets</h3>
        ...
        <div className="bg-white p-6 rounded-lg shadow border">
          <h3 className="text-lg font-semibold mb-4">Next Quarter Action Items</h3>
          <div className="space-y-3">
            <div className="flex items-center gap-3 p-3 border rounded-lg">
              <input type="checkbox" className="rounded" />
              <div className="flex-1">
                <p className="font-medium">Implement AI-powered application screening</p>
                <p className="text-sm text-gray-600">Reduce initial review time and improve consistency</p>
              </div>
            ...
            <div className="flex items-center gap-3 p-3 border rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600">Support first-time applicants to improve success rates</p>
              </div>
            ...
            <div className="flex items-center gap-3 p-3 border rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600">Create systematic approach to track project outcomes</p>
              </div>
